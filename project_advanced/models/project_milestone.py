...
class ProjectMilestone(models.Model):
    ...
    def _compute_progress(self):
        ...
        # where total is the number of top-level tasks assigned to that milestone and done is the number
        # of those tasks whose state is in CLOSED_STATES ('1_done' or '1_canceled').
        ...
        counts_per_milestone = {
            ...
            for milestone, count, state_list in self.env['project.task']._read_group(
                [('milestone_id', 'in', self.ids), ('parent_id', '=', False)],
                ['milestone_id'],
